                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <Link href="/" className="text-gray-400 hover:text-indigo-300 text-sm transition-colors">Home</Link>
                            <Link href="/products" className="text-gray-400 hover:text-indigo-300 text-sm transition-colors">Products</Link>
                            <Link href="/dashboard" className="text-gray-400 hover:text-indigo-300 text-sm transition-colors">Dashboard</Link>
                        </ul>
                    </div>
