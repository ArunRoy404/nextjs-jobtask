            ...
            <div className="">
                ...
                <div className="flex items-center justify-between mb-8">
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-700 flex justify-center">
                        <button
                            type="submit"
                            className="bg-indigo-600 disabled:cursor-not-allowed hover:bg-indigo-700 text-white px-8 py-3 rounded-lg font-medium transition-colors duration-200 flex items-center justify-center"
                            disabled={isLoading}
                        >
                            {
                                isLoading
